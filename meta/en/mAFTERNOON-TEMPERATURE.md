...
### About the Data
This metric reports the average modeled temperature between 3-4pm on a typical summer day in degrees Fahrenheit across each blockgroup or tract. The temperatures were modeled using a random forest machine learning model, trained on data points collected in July 2021 by Durham volunteers and the Museum of Life and Science as part of the CAPA Heat Watch Program.
