...
module.exports = {
  'mAVEAGE': {
    ...
    'title_es': 'TRANSLATE Average Age of Death',
    'decimals': 1,
    'type': 'mean',
  ...
  'mBACH': {
    ...
    'title_es': 'TRANSLATE Percent of Adults with a Bachelors Degree or More',
    'decimals': 1,
    'type': 'weighted',
    'geographies': [
      'tract',
  ...
  'mBIKEWK': {
    ...
    'title_es': 'TRANSLATE Commuting to Work by Bicycle',
    'decimals': 1,
    'type': 'weighted',
    'geographies': [
      'blockgroup',
  ...
  'mCC45': {
    ...
    'title_es': 'TRANSLATE Child Care Centers with 4 or 5 Star Ratings',
    'decimals': 1,
    'raw_label': 'centers',
    'type': 'weighted',
    'geographies': [
  ...
  'mCCC': {
    ...
    'title_es': 'TRANSLATE Child Care Centers per Square Mile',
  ...
  'mCLINIC': {
    ...
    'title_es': 'TRANSLATE Homes Near Health Care Clinics',
    'label': 'of households',
  ...
  'mCOB': {
    ...
    'title_es': 'TRANSLATE Commercial Certificates of Occupancy per Sq Mile',
    'decimals': 1,
    'type': 'weighted',
    'geographies': [
      'blockgroup',
  ...
  'mCOR': {
    ...
    'title_es': 'TRANSLATE Residential Certificates of Occupancy per Sq Mile',
    'decimals': 1,
    'type': 'weighted',
    'geographies': [
      'blockgroup',
  ...
  'mCPMTS': {
    ...
    'title_es': 'TRANSLATE Commercial Building Permit Values Per Sq Mile',
    'decimals': 0,
    'type': 'weighted',
    'geographies': [
      'blockgroup',
  ...
  'mD_SQM': {
    ...
    'title_es': 'TRANSLATE Drug Crimes per Square Mile',
  ...
  'mHMINC': {
    ...
    'title_es': 'TRANSLATE Median Homebuyer Income',
    'prefix': '$',
    'decimals': 0,
    'type': 'mean',
    'geographies': [
  ...
  'mLUDIV': {
    ...
    'title_es': 'TRANSLATE Land Use Diversity',
    'decimals': 1,
    'type': 'mean',
    'geographies': [
      'blockgroup',
  ...
  'mMEANRPMT': {
    ...
    'title_es': 'TRANSLATE Average Residential Building Permit Value',
    'decimals': 0,
    'type': 'weighted',
    'geographies': [
      'blockgroup',
  ...
  'mMEDGRENT': {
    ...
    'title_es': 'TRANSLATE Median Gross Rent',
    'prefix': '$',
    'decimals': 0,
    'type': 'weighted',
    'geographies': [
  ...
  'mMEDHV': {
    ...
    'title_es': 'TRANSLATE Median Home Value',
    'prefix': '$',
    'decimals': 0,
    'type': 'weighted',
    'geographies': [
  ...
  'mMEDINC': {
    ...
    'title_es': 'TRANSLATE Median Household Income',
    'decimals': 0,
    'type': 'weighted',
    'geographies': [
      'blockgroup',
  ...
  'mPCI': {
    ...
    'title_es': 'TRANSLATE Per Capita Income',
    'decimals': 0,
    'type': 'weighted',
    'geographies': [
      'blockgroup',
  ...
  'mPCTC30': {
    ...
    'title_es': 'TRANSLATE Long Commute Times',
    'suffix': '%',
    'raw_label': 'commuters',
    'decimals': 1,
    'type': 'weighted',
  ...
  'mPCTIMP': {
    ...
    'title_es': 'TRANSLATE Impervious Area',
    'suffix': '%',
    'decimals': 1,
    'type': 'weighted',
    'geographies': [
  ...
  'mPCTSSI': {
    ...
    'title_es': 'TRANSLATE Supplemental Security Income',
    'decimals': 1,
    'type': 'weighted',
    'geographies': [
      'tract',
  ...
  'mPCTTREE': {
    ...
    'category': 'Environment',
    'title': 'Tree Coverage',
    'title_es': 'TRANSLATE Tree Coverage',
    'suffix': '%',
    'decimals': 1,
    'type': 'weighted',
    'geographies': [
  ...
  'mPOPDENS': {
    ...
    'title_es': 'TRANSLATE Population Density',
    'decimals': 0,
    'type': 'weighted',
    'geographies': [
      'blockgroup',
  ...
  'mPROXBANK': {
    ...
    'title_es': 'TRANSLATE Homes Near Banks or Credit Unions',
    'decimals': 1,
    'type': 'weighted',
    'geographies': [
      'blockgroup',
  ...
  'mPROXBUS': {
    ...
    'title_es': 'TRANSLATE Homes Near Bus Stops',
    'decimals': 1,
    'type': 'weighted',
    'geographies': [
      'blockgroup',
  ...
  'mPROXGR': {
    ...
    'title_es': 'TRANSLATE Homes Near Grocery Stores',
    'decimals': 1,
    'type': 'weighted',
    'geographies': [
      'blockgroup',
  ...
  'mPROXPH': {
    ...
    'title_es': 'TRANSLATE Homes Near Pharmacies',
    'decimals': 1,
    'type': 'weighted',
    'geographies': [
      'blockgroup',
  ...
  'mPRUNSD': {
    ...
    'title_es': 'TRANSLATE Poor or Unsound State of Repair',
    'suffix': '%',
  ...
  'mPTBLKNL': {
    ...
    'title_es': 'TRANSLATE Black or African American',
    'decimals': 1,
    'type': 'weighted',
    'geographies': [
      'blockgroup',
  ...
  'mPTGNRL': {
    ...
    'title_es': 'TRANSLATE General Election Participation',
    'suffix': '%',
    'raw_label': 'voters',
    'decimals': 1,
    'type': 'weighted',
  ...
  'mPTPRIM': {
    ...
    'title_es': 'TRANSLATE Primary Election Participation',
    'suffix': '%',
    'raw_label': 'voters',
    'decimals': 1,
    'type': 'weighted',
  ...
  'mPTUND18': {
    ...
    'title_es': 'TRANSLATE Youth Population',
    'suffix': '%',
  ...
  'mP_SQM': {
    ...
    'title_es': 'TRANSLATE Property Crimes per Square Mile',
  ...
  'mRAVGYR': {
    ...
    'title_es': 'TRANSLATE Average Year of Residential Construction',
    'decimals': 0,
    'commas': false,
    'type': 'mean',
    'geographies': [
  ...
  'mRCODE': {
    ...
    'title_es': 'TRANSLATE Minimum Housing Code Violations per Square Mile',
  ...
  'mREVAL': {
    ...
    'title_es': 'TRANSLATE Tax Value Change',
    'suffix': '%',
    'decimals': 1,
    'type': 'mean',
    'geographies': [
  ...
  'mRPMTS': {
    ...
    'title_es': 'TRANSLATE Residential Building Permit Value Per Sq Mile',
    'label': 'per sq mi',
  ...
  'mSUMEJECT': {
    ...
    'title_es': 'TRANSLATE Summary Ejectments Per Square Mile',
  ...
  'mSWTORD': {
    ...
    'title_es': 'TRANSLATE Sidewalks to Roadways',
  ...
  'mVCODE': {
    ...
    'title_es': 'TRANSLATE Automotive Code Violations',
    'label': 'violations per sq mi',
    'raw_label': 'violations',
    'decimals': 1,
    'type': 'weighted',
  ...
  'mV_SQM': {
    ...
    'title_es': 'TRANSLATE Violent Crimes per Square Mile',
    'label': 'incidents per sq mi',
    'raw_label': 'incidents',
    'decimals': 1,
    'type': 'weighted',
  ...
  'mWCODE': {
    ...
    'title_es': 'TRANSLATE Unmaintained Property Violations per Sq Mile',
    'label': 'violations per sq mi',
    'raw_label': 'violations',
    'decimals': 1,
    'type': 'weighted',
  ...
  'mWKHOME': {
    ...
    'title_es': 'TRANSLATE Working from Home',
    'decimals': 1,
    'type': 'weighted',
    'geographies': [
      'blockgroup',
  ...
  'mWLKWK': {
    ...
    'title_es': 'TRANSLATE Walking to Work',
    'decimals': 1,
    'type': 'weighted',
    'geographies': [
      'blockgroup',
